    ...
    <section id="component-swiper-responsive-breakpoints">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title"><?php echo e($gallery['gallery_name']); ?></h4>
            </div>
            <div class="card-body">
                <div class="swiper-responsive-breakpoints swiper-container autoplay swiper-container-initialized swiper-container-horizontal swiper-container-pointer-events">
                    <div class="swiper-wrapper" id="swiper-wrapper-ae36354c41dbf2f10" aria-live="polite" style="transform: translate3d(-359.5px, 0px, 0px); transition-duration: 0ms;">
                        <?php $__currentLoopData = $gallery['files']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="swiper-slide swiper-slide-prev" role="group" aria-label="1 / 9" style="width: 319.5px; margin-right: 40px;">
                            <?php if(str_contains($file['filemime'], 'video')): ?>
                                <video controls muted autoplay>
                                    <source src="<?php echo e(env('BACKEND_APP_ASSETS_URL').$file['uri']); ?>" type="video/mp4" style="max-height: 600px">
                                </video>
                            <?php else: ?>
                                <img class="img-fluid" src="<?php echo e(env('BACKEND_APP_ASSETS_URL').$file['uri']); ?>" height="400px" alt="banner">
...
<?php echo $__env->make('layouts.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/dev/resources/views/gallery.blade.php ENDPATH**/ ?>