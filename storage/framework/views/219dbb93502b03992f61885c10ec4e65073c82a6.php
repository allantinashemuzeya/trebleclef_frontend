                ...
                yoco.showPopup({
                    ...
                    callback: async  (result) =>{
                        ...
                        if (result.error) {
                            ...
                            const results = await axios.post('/payfees/process-payment',{'payplan': pay_plan, '_token': '<?php echo e(csrf_token()); ?>','cardToken':result.id});
...
<?php echo $__env->make('layouts.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/dev/resources/views/fees-product.blade.php ENDPATH**/ ?>