<?php $__env->startSection('content'); ?>
    ...
    <div class="app-content content ecommerce-application m-0">
        ...
        <div class="content-wrapper container-xxl p-0">
            ...
            <iframe src="<?php echo e(env('APP_URL').'/chatify'); ?>" title="" width="100%" height="850px">
            </iframe>
        </div>
    </div>
    <!-- END: Content-->
...
<?php echo $__env->make('layouts.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/dev/resources/views/chatify/index.blade.php ENDPATH**/ ?>