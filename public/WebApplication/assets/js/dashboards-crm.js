...
!function () {
    ...
    var e = document.querySelector("#salesLastYear"), r = {
            chart: {
                height: 78,
                type: "area",
        ...
        r = {
            ...
            grid: {
                show: !1,
                padding: {top: -41, right: -10, left: -8, bottom: -22}
            },
            xaxis: {
    ...
    function s(t, e) {
        var r = config.colors_label.primary, s = config.colors.primary, a = [];
    ...
    var e = $.ajax({
            ...
            dataType: "json",
            async: !1
        }).responseJSON, r = document.querySelector("#earningReportsTabsOrders"),
    ...
    a = document.querySelectorAll(".chart-progress"), a && a.forEach(function (o) {
        var t = config.colors[o.dataset.color], e = o.dataset.series, t = {
        ...
        series: [{data: [2e3, 2e3, 4e3, 4e3, 3050, 3050, 2e3, 2e3, 3050, 3050, 4700, 4700, 2750, 2750, 5700, 5700]}],
        dataLabels: {enabled: !1},
        ...
        fill: {
            type: "gradient",
            gradient: {opacityFrom: .6, opacityTo: .15, stops: [0, 95, 100]}
        },
        xaxis: {
            labels: {show: !1},
            axisBorder: {show: !1},
