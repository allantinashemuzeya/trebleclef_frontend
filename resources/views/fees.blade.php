...
{{--                                            <button class="btn w-100 btn-outline-success mt-2">Your current plan</button>--}}
                                            <button class="btn w-100 btn-primary mt-2">Pay now</button>
...
{{--                                            <p class="card-text">For small to medium businesses</p>--}}
                                            <div class="annual-plan">
                                                <div class="plan-price mt-2">
                                                    <sup class="font-medium-1 fw-bold text-primary">R</sup>
                                                    <span class="pricing-standard-value fw-bolder text-primary">R300</span>
{{--                                                    <sub class="pricing-duration text-body font-medium-1 fw-bold">/month</sub>--}}
                                                </div>
                                                <small class="annual-pricing d-none text-muted"></small>
                                            </div>
...
{{--                                            <p class="card-text">Solution for big organizations</p>--}}
                                            <div class="annual-plan">
                                                <div class="plan-price mt-2">
                                                    <sup class="font-medium-1 fw-bold text-primary">R</sup>
                                                    <span class="pricing-enterprise-value fw-bolder text-primary">R2000</span>
{{--                                                    <sub class="pricing-duration text-body font-medium-1 fw-bold">/month</sub>--}}
                                                </div>
                                                <small class="annual-pricing d-none text-muted"></small>
                                            </div>
