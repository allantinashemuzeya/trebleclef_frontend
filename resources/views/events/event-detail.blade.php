...
@section('content')
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="author-info">
                                        ...
                                        <small
                                            class="text-muted text-body-heading text-white text-success"><sup>FROM </sup>&nbsp;{{ \Carbon\Carbon::parse($event['start_date'])->isoFormat('DD ddd MMM YYYY')}}
                                            -
                                            <stup>TO
                                            </stup>&nbsp;{{ \Carbon\Carbon::parse($event['start_date'])->isoFormat('DD ddd MMM YYYY')}}
                                    </div>
                                </div>
                                ...
                                <button type="button" class="btn btn-outline-success waves-effect"
                                        data-bs-toggle="modal" data-bs-target="#registerForEvent">
                                    REGISTER FOR EVENT
                                </button>
                                <!-- Modal -->
                                ...
                                <button id="checkout-button" onclick="pay({{json_encode($event['event_payment'])}})"
                                        class="btn btn-outline-danger waves-effect me-0 me-sm-1 mb-1 mb-sm-0">
                                    <i data-feather="cash" class="me-50"></i>
                            ...
                            <div class="d-flex mb-2">
                                ...
                                <div class="blog-info">
                                    ...
                                    <div class=" text-success mb-0">
                                        DATE: {{strtoupper( \Carbon\Carbon::parse($item['start_date'])->isoFormat('DD ddd MMM YYYY'))}}</div>
                                </div>
                            </div>
                        @endforeach
    ...
    <div class="form-modal-ex">
        ...
        <div class="modal fade text-start" id="registerForEvent" tabindex="-1" aria-labelledby="myModalLabel33"
                ...
                <div class="modal-content">
                    ...
                    <form action="#">
                        <div class="modal-body">
                            ...
                            <div class="mb-1">
                                <input type="text" value="{{Auth::user()->firstname}}" placeholder="Email Address"
                                       class="form-control">
                            </div>

                            <label>Last Name: </label>
                            <div class="mb-1">
                                <input type="text" value="{{Auth::user()->lastname}}" placeholder="Email Address"
                                       class="form-control">
                            </div>
                            ...
                            <div class="mb-1">
                                <input type="text" value="{{$currentUser->cellphoneNumber}}" placeholder="Email Address"
                                       class="form-control">
                            </div>
