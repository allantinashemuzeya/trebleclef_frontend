<div class="row">
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
        <div class="mb-1">
            ...
            <select name="student_level" class="form-control js-example-basic-single" wire:model="studentLevel" wire:change="change">
...
<div class="row">
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
        <div class="mb-1">
            ...
            <!-- <input id="email" class="form-control" type="email" name="email" :value="old('email')" required autofocus /> -->
            <select name="activity[]" multiple class="form-control">
