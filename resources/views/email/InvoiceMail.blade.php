                                                            ...
                                                            <td align="center" class="es-m-txt-c"
                                                                style="padding:0;Margin:0"><h2
                                                                    ...
                                                                    Order&nbsp;<a target="_blank"
                                                                                  ...
                                                                                  href="">{{$data['invoiceNumber']}}</a></h2></td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td align="center" class="es-m-p0r es-m-p0l"
                                                                ...
                                                                <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">
                                                                    ...
                                                                    {{ \Carbon\Carbon::now()->isoFormat('DD MMM')}},&nbsp;2022</p></td>
                                                        </tr>
                                                        <tr>
                                                            <td align="center" class="es-m-p0r es-m-p0l"
                                                        ...
                                                        <tr>
                                                            <td align="left"
                                                                style="padding:0;Margin:0;padding-bottom:15px"><p
                                                                    ...
                                                                    class="product-description">{{$data['payPlan']['description']}}</p>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="es-m-txt-l" align="left"
                                                                                        ...
                                                                                        <h3 style="Margin:0;line-height:24px;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;font-size:20px;font-style:normal;font-weight:bold;color:#666666"
                                                                                            class="price">R{{$data['payPlan']['price']}}</h3>
                                                                                    </td>
                                                                                </tr>
                                                                            </table>
                                                                        </td>
                                                    ...
                                                    <table cellpadding="0" cellspacing="0" width="100%"
                                                        ...
                                                        <tr>
                                                            <td align="left" style="padding:0;Margin:0"><p
                                                                    ...
                                                                    Customer: <strong>{{\Illuminate\Support\Facades\Auth::user()->email}}</strong>
                                                                </p>
                                                                <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">
                                                                    Order number:&nbsp;<strong>{{$data['invoiceNumber']}}</strong></p>
                                                                <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">
                                                                    Invoice date:&nbsp;<strong>{{ \Carbon\Carbon::now()->isoFormat('DD MMM')}}</strong></p>
                                                                <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">
...
{{--                                                                <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">--}}
{{--                                                                    <strong>{{\Illuminate\Support\Facades\Auth::user()->email}}<br>600 Montgomery--}}
{{--                                                                        St,<br>San Francisco, CA 94111</strong></p></td>--}}
{{--                                                        </tr>--}}
                                                    </table>
                                                </td>
                                            </tr>
