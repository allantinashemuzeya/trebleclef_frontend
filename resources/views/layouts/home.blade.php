...
<html
    class="loading dark-layout" data-layout="dark-layout" data-textdirection="ltr" lang="en">
<!-- BEGIN: Head-->
...
<ul class="main-search-list-defaultlist d-none">
    ...
    <li class="auto-suggestion"><a class="d-flex align-items-center justify-content-between w-100"
            ...
            <small class="search-data-size me-50 text-muted">&apos;150kb</small></a>
    </li>
    ...
    <li class="auto-suggestion"><a class="d-flex align-items-center justify-content-between w-100"
            ...
            <small class="search-data-size me-50 text-muted">&apos;256kb</small></a>
    </li>
