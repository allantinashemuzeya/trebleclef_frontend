                                                                    ...
                                                                    <tr>
                                                                        <td align="center" class="es-m-p0r es-m-p0l"
                                                                            ...
                                                                            <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">
                                                                                ...
                                                                                {{ \Carbon\Carbon::parse($data->created_at)->isoFormat('DD MMM')}},&nbsp;2022</p></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td align="center" class="es-m-p0r es-m-p0l"
                                                                ...
                                                                <table width="100%" cellspacing="0" cellpadding="0"
                                                                    ...
                                                                    <tr>
                                                                        <td align="center" style="padding:0;Margin:0"><img
                                                                                class="adapt-img"
                                                                                src="https://jtlrho.stripocdn.email/content/guids/CABINET_b2094cafdd779c25046fb07f9b3b29ed/images/63301557836089742.jpg"
                                                                                alt
                                                                                style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic"
                                                                                width="165"></td>
                                                                    </tr>
                                                                    ...
                                                                    <tr>
                                                                        <td align="left"
                                                                            style="padding:0;Margin:0;padding-bottom:15px"><p
                                                                                ...
                                                                                class="product-description">Lorem ipsum dolor sit
                                                                ...
                                                                <table cellpadding="0" cellspacing="0" width="100%"
                                                                    ...
                                                                    <tr>
                                                                        <td align="left" class="es-m-txt-l"
                                                                            ...
                                                                            <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">
                                                                                <strong>Customer Name and address <br>600 Montgomery
