...
@section('content')
    ...
    <style>
        ...
        #dashboard-analytics > div:nth-child(1) {
            margin-top: 50px;
        }
        ...
        #dashboard-analytics > div > div.col-lg-8.col-md-12.col-sm-12 > div{
            max-height: 410px;
        }
        ...
        #dashboard-analytics > div > div:nth-child(3){
            width: 73%;
            margin-left: 14%;
        }
    ...
    <div class="content-body">
        ...
        <section id="dashboard-analytics">
            ...
            <div class="row match-height">
                ...
                <div
                    class="{{ !empty($currentStudent->profile_picture) ? 'col-lg-8 col-md-12 col-sm-12' : 'col-lg-12 col-md-12 col-sm-12'  }}">
                                    ...
                                    <section id="component-swiper-progress">
                                        ...
                                        <div class="card-body" style="min-height:500px;">
                                            <div class="swiper-progress swiper-container">
                                                <div class="swiper-wrapper tct_sw" >
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        ...
                        <section id="component-swiper-pagination">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div
                                        class="swiper-paginations swiper-container swiper-container-initialized swiper-container-horizontal swiper-container-pointer-events">
                                        <div class="swiper-wrapper" id="swiper-wrapper-e110244a34aae927f"
                                             aria-live="polite" style="transform: translate3d(0px, 0px, 0px);">
                                            <div class="swiper-slide swiper-slide-active" role="group"
                                                 aria-label="1 / 5" style="width: 1396px;">
                                                <img class="img-fluid"
                                                     src="https://pixinvent.com/demo/vuexy-html-bootstrap-admin-template/app-assets/images/banner/banner-12.jpg"
                                                     alt="banner">
                                            </div>
                                            <div class="swiper-slide swiper-slide-next" role="group" aria-label="2 / 5"
                                                 style="width: 1396px;">
                                                <img class="img-fluid"
                                                     src="https://pixinvent.com/demo/vuexy-html-bootstrap-admin-template/app-assets/images/banner/banner-9.jpg"
                                                     alt="banner">
                                            </div>
                                            <div class="swiper-slide" role="group" aria-label="3 / 5"
                                                 style="width: 1396px;">
                                                <img class="img-fluid"
                                                     src="https://pixinvent.com/demo/vuexy-html-bootstrap-admin-template/app-assets/images/banner/banner-8.jpg"
                                                     alt="banner">
                                            </div>
                                            <div class="swiper-slide" role="group" aria-label="4 / 5"
                                                 style="width: 1396px;">
                                                <img class="img-fluid"
                                                     src="https://pixinvent.com/demo/vuexy-html-bootstrap-admin-template/app-assets/images/banner/banner-7.jpg"
                                                     alt="banner">
                                            </div>
                                            <div class="swiper-slide" role="group" aria-label="5 / 5"
                                                 style="width: 1396px;">
                                                <img class="img-fluid"
                                                     src="https://pixinvent.com/demo/vuexy-html-bootstrap-admin-template/app-assets/images/banner/banner-20.jpg"
                                                     alt="banner">
                                            </div>
                                        </div>
                                        <!-- Add Pagination -->
